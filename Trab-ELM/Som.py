...
def calcula_pca_visualizacao(dados,fim_normal,inicio_falha,falha):
  ...
  ax.scatter(transformed[pos,0], transformed[pos,1], transformed[pos,2],c='r',marker='o',label='Normal')
  ax.scatter(transformed[neg,0], transformed[neg,1], transformed[neg,2],c='b',marker='+',label='Falha')
...
def calcula_pca_visualizacao_1(dados,fim_normal,inicio_falha,falha):
    
  dados.ix[0:fim_normal:,18] = 0    
  dados.ix[inicio_falha:1500,18] = falha  
  valor_negativo = len(dados[dados.ix[:,18] == falha]) - 1
  file_label = dados.ix[:,18]
  dados = dados.drop(18,1)
  dim = dados.shape
...
dados = pd.read_csv("X.csv", sep=";", header=None)
calcula_pca_visualizacao_1(dados,1200,1201,9)
...
fig, ax = plt.subplots()
ax.plot(seq_1,predicao_final_treino, label='Treino')
ax.plot(seq_1,predicao_final_teste, label='Teste')
...
fig, ax = plt.subplots()
ax.plot(seq_2,predicao_final_treino_2, label='Treino')
ax.plot(seq_2,predicao_final_teste_2, label='Teste')
...
'''data = stdsc.fit_transform(data)'''
param1 = ['poly',9,[4,3]]
params_2 = range(-20,20)
for i in enumerate(params_2):
    param1[2] = [i[1],3]
    elm = ELMRegressor(100,param1)
    train,teste = elm_with_kernel(data,file_label,skf,elm)
    predicao_final_treino_3.append(train)
    predicao_final_teste_3.append(teste)  
    


fig, ax = plt.subplots()
ax.plot(params_2,predicao_final_treino_3, label='Treino')
ax.plot(params_2,predicao_final_teste_3, label='Teste')
...
'''plt.figure(1)
plt.subplot(211)
plt.plot(params_2,predicao_final_treino_3)
...
fig, ax = plt.subplots()
ax.plot(params_3,predicao_final_treino_4, label='Treino')
ax.plot(params_3,predicao_final_teste_4, label='Teste')
...
fig, ax = plt.subplots()
ax.plot(params_4,predicao_final_treino_5, label='Treino')
ax.plot(params_4,predicao_final_teste_5, label='Teste')
...
fig, ax = plt.subplots()
ax.plot(seq_5,predicao_final_treino_6, label='Treino')
ax.plot(seq_5,predicao_final_teste_6, label='Teste')
...
predicao_final_treino_10 = []
predicao_final_teste_10 = []
...
for i in enumerate(params_4):
    ...
    elm = ELMRegressor(100,param1)
    train,teste = elm_with_kernel(data,file_label,skf,elm)
    predicao_final_treino_10.append(train)
    predicao_final_teste_10.append(teste) 


fig, ax = plt.subplots()
ax.plot(params_4,predicao_final_treino_10, label='Treino')
ax.plot(params_4,predicao_final_teste_10, label='Teste')
plt.title("falha 7 com kernel poly - iniciando em 600")
legend = ax.legend(loc='upper center', shadow=True)
...
data = data.drop(18,1)
data = data.as_matrix()
maximo = predicao_final_teste_10.index(max(predicao_final_teste_10))
class_names = ['Normal','Falha7_kernel_poly']
...
predicao_final_treino_11 = []
predicao_final_teste_11 = []

data = pd.read_csv("X_6.csv", sep=";", header=None)
data.ix[0:300:,18] = 0
data.ix[301:1000,18] = 1
...
'''data = stdsc.fit_transform(data)'''
param1 = ['poly',9,[4,3]]
params_11 = range(-20,20)
for i in enumerate(params_11):
    param1[2] = [i[1],3]
    elm = ELMRegressor(100,param1)
    train,teste = elm_with_kernel(data,file_label,skf,elm)
    predicao_final_treino_11.append(train)
    predicao_final_teste_11.append(teste)  
    


fig, ax = plt.subplots()
ax.plot(params_11,predicao_final_treino_11, label='Treino')
ax.plot(params_11,predicao_final_teste_11, label='Teste')
plt.title("falha 6 com kernel polinomial - iniciando em 300")
...
data = data.drop(18,1)
data = data.as_matrix()
maximo = predicao_final_teste_11.index(max(predicao_final_teste_11))
class_names = ['Normal','Falha6_kernel_poly']


X_train, X_test, y_train, y_test = train_test_split(data, file_label, test_size=0.4, random_state=0)
param1 = ['rbf',9,3]
param1[2] = [params_11[maximo]]
elm = ELMRegressor(100,param1)
